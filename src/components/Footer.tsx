...
const socialLinks = [
  ...
  {
    name: 'GitHub',
    url: 'https://github.com/dominikhein',
    icon: (
      <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
  ...
  {
    name: 'Email',
    url: 'mailto:kontakt@dominikhein.de',
    icon: (
...
export function Footer() {
  return (
    <footer id="contact" className="relative border-t border-glass-border bg-bg-secondary">
      {/* Top gradient line */}
        ...
        <div className="grid gap-12 md:grid-cols-2 lg:grid-cols-4">
          ...
          >
            ...
            <ul className="space-y-3">
              <li>
                <a
                  href="mailto:kontakt@dominikhein.de"
                  className="text-text-secondary hover:text-accent"
                >
                  kontakt@dominikhein.de
                </a>
              </li>
